...
```{r resu1, out.width = "100%", fig.align = "center", fig.cap = "Quantile regression of BMI ploted f for fifferent marginal effects. The predictors modeled using quadratic terms ", echo = FALSE}
# Created by file exploratory-data-analysis.R
...
```{r resu12, out.width = "100%", fig.align = "center", fig.cap = "Quantile regression of BMI ploted f for fifferent marginal effects. The predictors modeled using splines ", echo = FALSE}
# Created by file exploratory-data-analysis.R
