# Plot of quantile regression for BMI regressed on Gender, Age,Race,Statin_status
#Using bsplines
require(quantreg)
library(tidyverse)
library(splines)
...
blab <- c("Intercept","Male ","RaceMexican", "RaceOther", "RaceOther_Hispanic ", "White ", " Statin_status" ,
...
png(file = here::here("images", "effect_Age_22.png"),
    res = 400, height = 9, width = 16, units = "in")
